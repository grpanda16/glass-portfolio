...
/** Public repositories, read live from the GitHub API on every page view. */
function Repos() {
...
export default function Projects() {
  useSeo({ ...PAGE_SEO['/projects'], path: '/projects' });

  return (
    <div className="wrap page">
      <Reveal className="page-head">
        <span className="pill"><span className="dot" />{PROJECTS.length} platforms · live repos</span>
        <h1 className="h-lg" style={{ margin: '20px 0 16px' }}>
          What I&apos;ve <span className="gradtext">shipped.</span>
        </h1>
        <p className="lede">
          Two platforms taken end to end — a B2B pharmacy marketplace and a financial document
          system — plus whatever is currently public on GitHub.
        </p>
      </Reveal>

      <div className="stack-lg" style={{ paddingBottom: 'clamp(20px,4vw,40px)' }}>
        <section id="platforms">
          <Reveal><div className="eyebrow"><span className="n">01</span> Platforms</div></Reveal>
        ...
        <section id="repositories">
          <Reveal>
            <div className="eyebrow"><span className="n">02</span> Repositories · live from GitHub</div>
          </Reveal>
          <Repos />
        </section>
        ...
        <section>
          <Reveal className="card cta-band">
            ...
            <div className="cta">
              ...
              <Link className="btn" to="/work">See the experience →</Link>
            </div>
          </Reveal>
        </section>
      </div>
